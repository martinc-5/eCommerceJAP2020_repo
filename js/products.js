    ...
    if (
      ...
      htmlContentToAppend += `
                ...
                <div class="card mb-4 box-shadow ">
                    ...
                    <div class="card-body">
                    <h4 class="card-title"><strong><a href="product-info.html" class="text-dark stretched-link">${product.name}</a></strong> <br><span class="badge badge-secondary">${product.currency} ${product.cost}</span></h4>
